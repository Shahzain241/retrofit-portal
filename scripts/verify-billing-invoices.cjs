 ...
 * `invoices` table provisioning (scripts/setup-invoices.cjs):
 *
 ...
 *
 * Usage: node scripts/verify-billing-invoices.cjs
 */
...
const SETUP_SRC = fs.readFileSync(path.join(__dirname, 'setup-invoices.cjs'), 'utf8');
