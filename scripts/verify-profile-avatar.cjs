 ...
 * `avatars` Storage bucket provisioning (scripts/setup-avatars-bucket.cjs):
 *
 ...
 *
 * Usage: node scripts/verify-profile-avatar.cjs
 */
...
const SETUP_SRC = fs.readFileSync(
  path.join(__dirname, 'setup-avatars-bucket.cjs'),
  'utf8',
);
