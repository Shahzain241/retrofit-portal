 ...
 *      scripts/sql/12_project_documents_table.sql) storing the Storage PATH
 ...
 * (a personal access token starting with `sbp_`, see .env.example).
 *
 * Usage: SUPABASE_MANAGEMENT_TOKEN=sbp_... node scripts/setup-project-documents-bucket.cjs
 */
