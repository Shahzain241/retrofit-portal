    ...
    <div className="rp-root">
      <style>{`
        ...
        @media (max-width: 980px) {
          ...
          .rp-hiw-grid { grid-template-columns: 1fr; grid-auto-rows: auto; }
      ...
      <header className="rp-header">
        <nav className="rp-nav">
          ...
          <div className="rp-nav-actions">
            <button className="rp-btn rp-btn-outline-dark" onClick={() => navigate("/login")}>Login</button>
            <button className="rp-btn rp-btn-primary" onClick={() => navigate("/signup")}>Get Started</button>
          ...
          <div className="rp-hero-row">
            <div className="rp-hero-inner">
              ...
              <div className="rp-hero-actions">
                <button className="rp-btn rp-btn-white" onClick={() => navigate("/signup")}>Sign Up</button>
                <button className="rp-btn rp-btn-outline-white" onClick={() => navigate("/login")}>Login</button>
                <button className="rp-btn rp-btn-outline-white" onClick={scrollToId("services")}>Browse Services</button>
              </div>
            </div>
