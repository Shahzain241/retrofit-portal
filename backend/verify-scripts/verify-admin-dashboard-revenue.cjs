 ...
 * policy (backend/sql/16_invoices_super_admin_policy.sql — applied via
 * backend/setup-scripts/setup-invoices-admin-policy.cjs).
 *
 ...
 * Usage: node backend/verify-scripts/verify-admin-dashboard-revenue.cjs
 */
