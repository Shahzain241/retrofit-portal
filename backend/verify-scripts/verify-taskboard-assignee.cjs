 ...
 *
 * Requires backend/verify-scripts/verify-taskboard.cjs (15/15) and
 * backend/verify-scripts/verify-taskboard-rls-fix.cjs (7/7) to still pass — run them
 ...
 * Usage: node backend/verify-scripts/verify-taskboard-assignee.cjs
 */
