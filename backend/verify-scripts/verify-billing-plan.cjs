 ...
 * account. Usage: node backend/verify-scripts/verify-billing-plan.cjs
 */
...
const SETUP_SRC = fs.readFileSync(path.join(__dirname, '..', 'setup-scripts', 'setup-billing.cjs'), 'utf8');
